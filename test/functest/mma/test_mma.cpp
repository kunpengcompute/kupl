...
test_kupl_za
void KP36_16x64x2_BF16BF16F32_kernel(bfloat16_t *pack_data_a, bfloat16_t *pack_data_b, float *data_c) test_kupl_streaming
{
...
TEST(test_mma, KP36_16x64x2_BF16BF16F32)
{
    ...
    KP36_16x64x2_BF16BF16F32_kernel(pack_data_a, pack_data_b, data_c);
...
test_kupl_za
void KP36_16x64x1_BF16BF16F32_kernel(bfloat16_t *pack_data_a, bfloat16_t *pack_data_b, float *data_c) test_kupl_streaming
{
...
TEST(test_mma, KP36_16x64x1_BF16BF16F32)
{
    ...
    KP36_16x64x1_BF16BF16F32_kernel(pack_data_a, pack_data_b, data_c);
...
test_kupl_za
void KP36_16x64x4_INT8INT8INT32_kernel(int8_t *pack_data_a, int8_t *pack_data_b, int32_t *data_c) test_kupl_streaming
{
...
TEST(test_mma, KP36_16x64x4_INT8INT8INT32)
{
    ...
    KP36_16x64x4_INT8INT8INT32_kernel(pack_data_a, pack_data_b, data_c);
...
test_kupl_za
void KP36_32x32x4_INT8INT8INT32_kernel(int8_t *pack_data_a, int8_t *pack_data_b, int32_t *data_c) test_kupl_streaming
{
...
TEST(test_mma, KP36_32x32x4_INT8INT8INT32)
{
    ...
    KP36_32x32x4_INT8INT8INT32_kernel(pack_data_a, pack_data_b, data_c);
